...
function AppLayout({ children }) {
  ...
  const getPageInfo = () => {
    ...
    const pageMap = {
      ...
      "/create": {
        label: "AI Generate",
        icon: Wand2,
        description: "Create graphs from text or docs",
      },
      "/graphs": {
        label: "Custom Build",
        icon: Move,
        description: "Your custom graphs",
      },
      "/graphs/new": {
        label: "Graph Builder",
        icon: Move,
        description: "Drag & drop graph builder",
      },
      "/graphs/builder": {
        label: "Graph Builder",
        icon: Move,
  ...
  return (
    <div
      className={`flex min-h-screen ${isDark ? "bg-dark-950" : "bg-gray-50"}`}
    >
      {/* Sidebar */}
      <Sidebar />
      ...
      <main className="flex-1 min-h-screen overflow-x-hidden flex flex-col">
        ...
        {/* Top Header Bar */}
        <header
          className={`sticky top-0 z-30 px-4 lg:px-6 py-3 border-b backdrop-blur-xl
          ${
            isDark
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative" ref={notificationRef}>
                ...
                {showNotifications && (
                  <div
                    className={`absolute right-0 mt-2 w-80 rounded-xl border-2 shadow-2xl overflow-hidden z-50
                    ${
                      isDark
